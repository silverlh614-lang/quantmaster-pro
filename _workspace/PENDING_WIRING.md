...
| C10 | 0149/0154/0156 Phase 4 외부 컨센서스 | `server/clients/yahooConsensusClient.ts` | DECIDED_NOT_WIRING | P2 | **PR-Phase5 (2026-05-01) 완료** — ADR-0156 옵션 A 변형 채택 (Yahoo 무료 quoteSummary recommendationTrend + earningsHistory). `consensusTarget` (#13) + `earningsSurprise` (#14) 격상. 한국 종목 가용률 30~50% 추정, 부재 시 stock.checklist 보존. 27 조건 격상 진행도 70% → 78%. |
