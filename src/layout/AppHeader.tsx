      ...
      <div className="max-w-screen-2xl mx-auto px-4 sm:px-6 h-[56px] sm:h-[60px] flex items-center justify-between gap-3 sm:gap-4">
        ...
        >
          <div className="relative">
            <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-orange-400 via-orange-500 to-red-600 rounded-xl flex items-center justify-center shadow-[0_0_20px_rgba(249,115,22,0.5)] group-hover:shadow-[0_0_30px_rgba(249,115,22,0.7)] transition-shadow">
          ...
          <div className="hidden sm:flex flex-col leading-none">
            <span className="text-[13px] font-black text-theme-text tracking-tight group-hover:text-orange-400 transition-colors">QuantMaster <span className="text-orange-500">Pro</span></span>
