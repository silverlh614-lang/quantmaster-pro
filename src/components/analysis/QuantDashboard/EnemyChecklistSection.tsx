  ...
  return (
    <div className="p-8 border border-theme-text bg-theme-text text-white shadow-[8px_8px_0px_0px_rgba(249,115,22,1)]">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-xl font-black uppercase tracking-tight">적군 체크리스트 (하락 시나리오)</h3>
      </div>
      <div className="space-y-6">
        <div>
          <span className="text-[10px] font-black text-orange-500 tracking-tight block mb-2">최악의 시나리오</span>
          <p className="text-sm italic leading-relaxed text-gray-300">"{result.enemyChecklist.bearCase}"</p>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <span className="text-[10px] font-black text-red-400 tracking-tight block mb-2">리스크 요인</span>
          ...
          <div>
            <span className="text-[10px] font-black text-blue-400 tracking-tight block mb-2">반론</span>
            <ul className="space-y-1">
