  ...
  return (
    <div className="mb-12 p-8 border border-theme-text bg-white">
      <div className="flex items-center gap-3 mb-6">
        ...
        <h3 className="text-xl font-black uppercase tracking-tight">포트폴리오 상관관계</h3>
      </div>
      <div className="flex items-center gap-8">
        <div className="flex-1">
          <div className="h-4 w-full bg-gray-100 border border-theme-text relative">
            ...
            />
            <div className="absolute -top-6 left-0 text-[8px] font-black text-gray-400">낮음 (-1.0)</div>
            <div className="absolute -top-6 right-0 text-[8px] font-black text-gray-400">높음 (+1.0)</div>
          </div>
        </div>
        <div className="text-right">
          <span className="text-2xl font-black font-mono">{score.toFixed(2)}</span>
          <p className="text-[10px] font-black text-gray-400 tracking-tight">상관관계 지수</p>
        </div>
      </div>
