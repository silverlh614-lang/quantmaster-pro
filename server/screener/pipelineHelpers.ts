...
/** 레짐별 주도 섹터 (확장: 전력기기·방산·AI반도체·의료미용 추가) */
export const LEADING_SECTORS: Record<string, string[]> = {
  R1_TURBO:   ['반도체', 'AI반도체', '방산', '조선', '원자력', '2차전지', '전력기기', '조선엔진'],
  R2_BULL:    ['반도체', 'AI반도체', '2차전지', 'IT서비스', '바이오', 'AI', '전력기기'],
  R3_EARLY:   ['금융', '조선', '소재', '원자력', '전력기기', '방산', '건설기계'],
