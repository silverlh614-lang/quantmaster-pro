// @responsibility 17:00 KST after-hours runtime debug snapshot 자동 capture cron (Patch-AFTER-HOURS-RUNTIME-DEBUG-SNAPSHOT-001/002).
...
/**
 * cron entry — 매 평일 17:00 KST = UTC 08:00 (평일 1-5).
 *
 * 사용자 명시 capture 시간 (절대 변경 금지):
 *   - 17:00 KST — 장 종료(15:30) + 1.5h 후, latest intraday runtime state 안정화 시점
 ...
 *   - 금요일 snapshot 은 주말 유지 → 월요일 17:00 성공 시 overwrite
 *
