...
export const SCHEDULE_CATALOG: ScheduleEntry[] = [
  { timeKst: '상시', label: 'Shadow 봇: 거래일 08:45/16:10, 일 19:00, 매분 변화 점검', group: 'reports', jobName: 'paper_bot', silentWhen: '예정 보고 또는 새 가상 매매·운영 상태 변화가 없으면 무음' },
  // ── 리포트 (Telegram 송출 중심) ────────────────────────────────────────────
  ...
  { timeKst: '08:38', label: '시장 자료 갱신 (아침)', group: 'reports', jobName: 'market_data_refresh_morning', silentWhen: '내부 캐시 갱신만 — Telegram 송출 없음' },
  ...
  // VIX 수집은 동일 시각 market_volatility_open(trading) 으로 별도 등록되어 있음.
  { timeKst: '09:00', label: 'MHS 지표 알림', group: 'alerts', jobName: 'mhs_morning_alert', silentWhen: 'MHS 가 RED(<40) 또는 GREEN(≥70) 전환이 아니면 무음' },
  ...
  { timeKst: '09:00', label: 'VIX 실측값 장 시작 수집', group: 'trading', jobName: 'market_volatility_open', silentWhen: '시장자료 저장만 — Telegram 송출 없음' },
  ...
  { timeKst: '15:30', label: '시장 자료 갱신 (장마감)', group: 'reports', jobName: 'market_data_refresh_close', silentWhen: '내부 캐시 갱신만 — Telegram 송출 없음' },
  ...
  { timeKst: '상시',  label: 'VIX 실측값 수집 (장중 30분, 09:30~14:30)', group: 'trading', jobName: 'market_volatility_intraday', silentWhen: '시장자료 저장 — Telegram 송출 없음' },
  ...
  { timeKst: '상시',  label: '시장 자료 장중 TTL refresh (3분)', group: 'reports', jobName: 'market_data_refresh_intraday_ttl', silentWhen: '내부 캐시 갱신만 — Telegram 송출 없음' },
