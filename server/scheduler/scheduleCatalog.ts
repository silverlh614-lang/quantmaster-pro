...
export const SCHEDULE_CATALOG: ScheduleEntry[] = [
  ...
  { timeKst: '17:00', label: 'After-hours runtime debug snapshot capture (Patch-AFTER-HOURS-RUNTIME-DEBUG-SNAPSHOT-001/002)', group: 'maintenance', jobName: 'runtime_debug_snapshot_capture', silentWhen: 'RUNTIME_DEBUG_SNAPSHOT_DISABLED=true 이거나 KRX 휴장일이면 무음 — 17:00 = 장 종료 +1.5h, replay 시 SELL_ONLY 의미 부여 금지 (sessionInterpretation=INTRADAY_REPLAY_EQUIVALENT). 다음 거래일 17:00 성공 capture 시 single-latest overwrite, 금→월 lifecycle 보존.' },
