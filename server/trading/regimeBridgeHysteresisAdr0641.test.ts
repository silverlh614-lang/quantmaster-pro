// @responsibility ADR-0641 getRegimeDiagnostics 히스테리시스 wiring 회귀 — flag OFF 즉시(byte-identical) / ON 보류→dwell 후 채택 / R6 즉시 예외.
...
describe('ADR-0641 getRegimeDiagnostics 히스테리시스 wiring', () => {
