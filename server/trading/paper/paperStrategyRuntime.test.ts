...
const state = vi.hoisted(() => ({
  ...
  collect: vi.fn(), saveBaseline: vi.fn(), saveStrategy: vi.fn(), loadStrategy: vi.fn(),
}));
vi.mock('../../persistence/paperExperimentRepo.js', () => ({
  loadPaperExperimentLedger: () => structuredClone(state.baseline), savePaperExperimentLedger: state.saveBaseline,
}));
