...
describe('ADR-0484 Supply Coverage Recovery Observation', () => {
  ...
  it('10. Calculates Gate1 near-miss and observation row counts', () => { const s = buildSupplyCoverageSnapshotAdr0484({ scanSummary: { time: 't', candidates: 1, trackB: 0, swing: 0, catalyst: 0, momentum: 0, quoteFails: 0, gateMisses: 0, rrrMisses: 0, entries: 0, gateScoreCandidateBuckets: { counts: { DATA_BLOCKED_NEAR_MISS: 2 } as any, dataBlockedNearMissTopUnavailable: [], probingTopConditions: [], totalNearMissLike: 2 } }, gate1DryRunObservationLedgerAdr0476: summarizeGate1DryRunObservationRows([]) }); expect(s.gateDiagnostics.gate1NearMissCount).toBe(2); expect(s.gateDiagnostics.dryRunObservationRows).toBe(0); });
