...
const PROGRAM_FLOW_AVAILABLE_OUTSIDE_LIVE_WINDOW = 'PROGRAM_FLOW_AVAILABLE_OUTSIDE_LIVE_WINDOW';
const DATA_PARSED_BUT_DIAGNOSTIC_ONLY_OUTSIDE_LIVE_WINDOW =
  'DATA_PARSED_BUT_DIAGNOSTIC_ONLY_OUTSIDE_LIVE_WINDOW';
const MARKET_PROGRAM_OUTSIDE_LIVE_WINDOW_USER_MESSAGE =
