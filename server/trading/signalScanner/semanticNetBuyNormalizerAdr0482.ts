...
function sourceIdForProvider(provider: SemanticNetBuyProvider): string {
  if (provider === 'NAVER') return 'NAVER_INVESTOR_TREND';
  if (provider === 'KIS') return 'KIS_PROGRAM_TRADING';
