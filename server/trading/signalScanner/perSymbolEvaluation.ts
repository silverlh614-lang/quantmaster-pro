...
export async function evaluateMainCandidates(
  ...
  registerEntryCandidateSnapshots(
    ...
    buyList.map((w: any) => ({
      ...
      kospi20dReturn: w.kospi20dReturn ?? w.symbolFeatures?.kospi20dReturn ?? w.quote?.kospi20dReturn ?? w.featurePack?.momentum?.kospi20dReturn ?? w.momentumProjection?.kospi20dReturn,
