...
import {
  renderKisIndexQuoteClientStatusLineAdr0544,
  renderSectorEnergyHealthBlockAdr0544,
} from './sectorEnergyMasterSupplyUnknownPolicyAdr0488/sessionDisplayAdr0544.js';
import {
...
export function buildSectorEnergyMasterReportAdr0488(
  ...
  if (officialSectorIndexMaster) {
    ...
    diagnostics.push(`${renderKisIndexQuoteClientStatusLineAdr0544(officialSectorIndexMaster, 'KisIndexQuoteClientStatus')}.`);
...
export function formatSectorEnergySupplyUnknownCompactAdr0488(report: SectorEnergyAndSupplyUnknownPolicyReportAdr0488): string {
  ...
  return [
    ...
    ...(master ? [
      ...
      renderKisIndexQuoteClientStatusLineAdr0544(master, 'KisIndexQuoteClientStatus:'),
