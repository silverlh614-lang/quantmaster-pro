...
export const KIS_OFFICIAL_ENDPOINTS_BY_PATH = Object.fromEntries(
  Object.values(KIS_OFFICIAL_ENDPOINTS).map((spec) => [spec.path, spec]),
) as Record<string, KisOfficialEndpointSpec>;
