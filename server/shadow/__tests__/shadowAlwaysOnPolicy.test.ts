...
describe('resolveShadowAlwaysOnPolicy', () => {
  ...
  it('keeps SELL_ONLY evaluation and Shadow learning alive while blocking live buys', () => {
    ...
    expect(policy.reason).toBe('SELL_ONLY_EVALUATION_CONTINUED_LIVE_BUY_BLOCKED');
  });
