...
/** ADR-0624 — 실행 청산(HIT_STOP) 포지션 손절-후 N일 수익률 관측 전용 라벨 ledger(shadow-trades.json 영속 본체와 물리 분리, default OFF). */
export const SHAKEOUT_STOP_OUTCOME_LEDGER_FILE = path.join(DATA_DIR, 'shakeout-stop-outcome-ledger-adr0624.json');
