...
/** ADR-0614 — 외국인/기관 연속 순매수 관측 전용 시계열 ledger(투자자흐름 cache·진단 ledger 와 물리 분리, default OFF). */
...
/** ADR-0642 — 5개 default-OFF Gate1 flag shadow 증거 세션 누적 레지스트리(per-scan 5-flag 1행 append, 위 ledger 들과 물리 분리, 관측 전용·flag flip 0·executionImpact=NONE). */
export const GATE1_FLAG_SHADOW_EVIDENCE_FILE = path.join(DATA_DIR, 'gate1-flag-shadow-evidence.json');
