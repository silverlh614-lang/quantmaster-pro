...
// @responsibility: commands/trade/* 13 cmd 자동 등록 (buy/sell/cancel/adjust_qty/reconcile+reconcile_qty/scan/scan_force/force_watch_scan/krx_scan/leader_refresh/stage1_audit/report/shadow).
