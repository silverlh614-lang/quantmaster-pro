...
export function formatLearningPulseMessage(s: ReturnType<typeof collectLearningPulse>): string {
  const extra = [
    ...
    `Counterfactual Maturity: maturityStatus=${s.counterfactualMaturity.maturityStatus} / maturedNowCount=${s.counterfactualMaturity.maturedNowCount} / waitingForHoldingPeriod=${s.counterfactualMaturity.waitingCount} / overdueCount=${s.counterfactualMaturity.overdueCount} / nearestMaturityAt=${s.counterfactualMaturity.nearestMaturityAt ?? 'N/A'} / remainingCalendarDays=${s.counterfactualMaturity.remainingCalendarDaysToNearestMaturity ?? 'N/A'} / remainingTradingDays=${s.counterfactualMaturity.remainingTradingDaysToNearestMaturity ?? 'N/A'} / maturityBucketTop=${s.counterfactualMaturity.maturityBucketTop} / nextResolveAt=${s.counterfactualMaturity.nextResolveAt ?? 'N/A'} / bucketSumMatchesPending=${s.counterfactualMaturity.bucketSumMatchesPending} / resolverSchedulerStatus=${s.counterfactualMaturity.schedulerStatus}`,
