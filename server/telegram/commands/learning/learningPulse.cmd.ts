...
export function formatLearningPulseMessage(s: ReturnType<typeof collectLearningPulse>): string {
  ...
  const extra = [
    ...
    `Fresh Shadow Inlet: liveBlocker=${s.freshShadowInlet.liveBlocker ?? 'NONE'} / shadowInletStatus=${s.freshShadowInlet.shadowInletStatus ?? s.freshShadowInlet.nextAction} / scanCandidatesToday=${s.freshShadowInlet.scanCandidatesToday} / shadowSignalsToday=${s.freshShadowInlet.shadowSignalsToday} / shadowApprovedToday=${s.freshShadowInlet.shadowApprovedToday} / shadowOrdersCreatedToday=${s.freshShadowInlet.shadowOrdersCreatedToday} / paperFilledToday=${s.freshShadowInlet.paperFilledToday} / counterfactualAllowed=${s.freshShadowInlet.counterfactualAllowed} / executionImpact=${s.freshShadowInlet.executionImpact}`,
