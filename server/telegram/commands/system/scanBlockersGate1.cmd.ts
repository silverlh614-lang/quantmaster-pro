...
function formatGate1ForensicCompact(forensic: Gate1MinimumSignalForensicSummaryAdr0505 | undefined): string[] {
  ...
  return [
    ...
    `watchlistScoreNormalized=${numberText(forensic.watchlistScoreNormalized)}/${numberText(forensic.totalCandidates)}`,
    `watchlistScoreMissing=${numberText(forensic.watchlistScoreMissing)}`,
    `watchlistScoreScaleFixed=${numberText(forensic.watchlistScoreScaleFixed)}`,
    `promotionScoreCopied=${numberText(forensic.promotionScoreCopied)}`,
    ...
    `maAlignmentComputed=${numberText(forensic.maAlignmentComputed)}/${numberText(forensic.totalCandidates)}`,
    `return5dAvailable=${numberText(forensic.return5dAvailable)}/${numberText(forensic.totalCandidates)}`,
    `return20dAvailable=${numberText(forensic.return20dAvailable)}/${numberText(forensic.totalCandidates)}`,
    `technicalProjectionBreakPoint=${topKey(forensic.technicalProjectionBreakPoint)}`,
    `maAlignmentAdvisoryOnly=${numberText(forensic.maAlignmentAdvisoryOnlyCount)}`,
    `technicalTrendDeathHardBlock=${numberText(forensic.technicalTrendDeathHardBlockCount)}`,
    ...
    `supplyMissingNeutralized=${numberText(forensic.supplyMissingNeutralized)}`,
