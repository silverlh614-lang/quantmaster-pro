...
/**
 * Production KRX master guard.
 * Throws on partial universe, stale master, or static fallback source.
 */
...
/** Normalize Yahoo/KIS/KRX inputs to exactly six numeric KRX code digits. */
...
/**
 * Separates actual filter failures from data-missing failures.
 * This prevents DATA_MISSING_* from being disguised as LOW_VOLUME/HIGH_PER/MIN_PRICE.
 */
