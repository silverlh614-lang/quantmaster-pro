...
(2026-05-01 기준, 마지막 발급 0147, 누락 6개 — 0062/0063/0089/0105/0106/0143)

> 주의: 0146 (PR-Governance-3, PR #502 진행 중) 과 0147 (본 ADR, KIS 토큰 영속) 이 같은 PR 시리즈에서 동시 발급. PR 머지 순서에 따라 본 INDEX.md 표가 일시적으로 한쪽만 반영될 수 있음 — 양쪽 머지 후 정합화.
...
**총 발급 146건** (152 파일 − 충돌 그룹 17건 + 충돌 그룹 표 카운트 = 146 unique 번호) / **누락 7건** (0062/0063/0089/0105/0106/0143/0146) / **다음 발급 0148**.

> 0146 누락 표기는 *임시* — PR-Governance-3 (PR #502) 머지 시 0146 (pr-pace-audit-rule, governance) 등재되어 누락 6건으로 정합화.
