...
**최대 발급 0585 · 다음 발급 0586** — `node scripts/check_adr_index.js --json` 기준 392 파일 · 375 unique 번호 (2026-06-07 실측·validate:adrIndex). 카운트 SSOT = `validate:adrIndex`, 충돌·누락 분류는 위 §"알려진 충돌"·§"누락".
