...
**최대 발급 0590 · 다음 발급 0591** — `node scripts/check_adr_index.js --json` 기준 (2026-06-09 실측·validate:adrIndex). 카운트 SSOT = `validate:adrIndex`, 충돌·누락 분류는 위 §"알려진 충돌"·§"누락".
