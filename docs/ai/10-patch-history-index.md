...
- 2026-05-27 · Patch-GATE1-THRESHOLD-EVIDENCE-EMIT · scan_blockers-full, gate1ThresholdEvidence-report(server/quant/gate1ThresholdEvidence.ts), scoreBandTable(70+/65~70/60~65/55~60/below55 × count/matureD1-D3-D5/avgReturnD1-D3-D5/winRateD5/hitPlus3/hitMinus3/avgMFE/avgMAE/expectancyR/falseNegativeRate), regimeSplit+dataQualitySplit, formatGate1ThresholdEvidenceSection-always-renders(skeleton→INSUFFICIENT_SAMPLE/OBSERVE_MORE-N/A), wired-between-FinalGate1Calibration-and-Gate1ScoringAlignment, ScanSummary.gate1ThresholdEvidence-optional-slot, emit-only(suggest-only, requiredScore=70-untouched, thresholdAutoChanged=false, liveExecutionAllowed=false), distinct-from-Gate3-Threshold-Evidence, executionImpact-NONE
