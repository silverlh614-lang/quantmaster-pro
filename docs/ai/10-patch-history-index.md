...
- 2026-05-28 · Patch-WIRE-Selected-Candidate-Actual-Row · signalScanner supply-carry, injectPerSymbolSupplyContext 후보전체 per-symbol flow→단일 aggregate by-symbol snapshot(buildInvestorFlowBySymbolCarryMap, MAX_SNAPSHOTS=20 cap 제거 → forensic by-symbol 조회 gateScoreEligible/semanticAvailable ~21→30+/49), program placeholder partial 허용, stats.investorFlowBySymbolCount 진단, 매매/threshold/scoring/order 무변경, marketSignal=false/usableForGate=false/executionImpact-NONE(SHADOW_ONLY)
